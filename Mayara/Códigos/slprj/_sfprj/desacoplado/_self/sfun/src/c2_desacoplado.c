...
#include "desacoplado_sfun.h"
#include "c2_desacoplado.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "desacoplado_sfun_debug_macros.h"
...
static void initialize_c2_desacoplado(SFc2_desacopladoInstanceStruct
  *chartInstance);
static void initialize_params_c2_desacoplado(SFc2_desacopladoInstanceStruct
  *chartInstance);
static void enable_c2_desacoplado(SFc2_desacopladoInstanceStruct *chartInstance);
static void disable_c2_desacoplado(SFc2_desacopladoInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_desacoplado
  (SFc2_desacopladoInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_desacoplado
  (SFc2_desacopladoInstanceStruct *chartInstance);
static void set_sim_state_c2_desacoplado(SFc2_desacopladoInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_desacoplado(SFc2_desacopladoInstanceStruct
  *chartInstance);
static void sf_c2_desacoplado(SFc2_desacopladoInstanceStruct *chartInstance);
static void c2_chartstep_c2_desacoplado(SFc2_desacopladoInstanceStruct
  *chartInstance);
static void initSimStructsc2_desacoplado(SFc2_desacopladoInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_desacopladoInstanceStruct *chartInstance,
  const mxArray *c2_dh, const char_T *c2_identifier, real_T c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_desacopladoInstanceStruct *chartInstance,
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_desacopladoInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_eml_error(SFc2_desacopladoInstanceStruct *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_desacopladoInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_ctes_bus_io(void *chartInstanceVoid, void *c2_pData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_desacopladoInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_desacoplado, const char_T
  *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_desacopladoInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_desacopladoInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_desacoplado = 0U;
}
  ...
  (SFc2_desacopladoInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_desacoplado;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_desacoplado = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_desacoplado");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_desacoplado(chartInstance);
...
static void sf_c2_desacoplado(SFc2_desacopladoInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_desacoplado(chartInstance);
  sf_debug_check_for_state_inconsistency(_desacopladoMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_desacopladoInstanceStruct *chartInstance;
  chartInstance = (SFc2_desacopladoInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i12 = 0; c2_i12 < 4; c2_i12++) {
    c2_b_inData[c2_i12] = (*(real_T (*)[4])c2_inData)[c2_i12];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i16 = 0; c2_i16 < 4; c2_i16++) {
    c2_n_u[c2_i16] = c2_u.hlin[c2_i16];
  }
  ...
  for (c2_i18 = 0; c2_i18 < 2; c2_i18++) {
    c2_p_u[c2_i18] = c2_u.vlin[c2_i18];
  }
...
const mxArray *sf_c2_desacoplado_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c2_ctes_bus_io(void *chartInstanceVoid, void *c2_pData)
{
  ...
  for (c2_i24 = 0; c2_i24 < 4; c2_i24++) {
    c2_tmp.hlin[c2_i24] = ((real_T *)((char_T *)c2_pData + 96))[c2_i24];
  }

  for (c2_i25 = 0; c2_i25 < 4; c2_i25++) {
    c2_tmp.h0[c2_i25] = ((real_T *)((char_T *)c2_pData + 128))[c2_i25];
  }

  for (c2_i26 = 0; c2_i26 < 2; c2_i26++) {
    c2_tmp.vlin[c2_i26] = ((real_T *)((char_T *)c2_pData + 160))[c2_i26];
  }
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_desacoplado), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_desacoplado);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_desacoplado_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1595936934U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3081042583U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4154379423U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1748893136U);
}

mxArray *sf_c2_desacoplado_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_desacoplado(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dh\",},{M[8],M[0],T\"is_active_c2_desacoplado\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_desacoplado_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_desacopladoInstanceStruct *chartInstance;
    chartInstance = (SFc2_desacopladoInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_desacopladoMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_desacopladoMachineNumber_,
            chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_desacopladoMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_desacopladoMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c2_desacoplado(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_desacopladoInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_desacoplado((SFc2_desacopladoInstanceStruct*)
    chartInstanceVar);
  initialize_c2_desacoplado((SFc2_desacopladoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_desacoplado(void *chartInstanceVar)
{
  enable_c2_desacoplado((SFc2_desacopladoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_desacoplado(void *chartInstanceVar)
{
  disable_c2_desacoplado((SFc2_desacopladoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_desacoplado(void *chartInstanceVar)
{
  sf_c2_desacoplado((SFc2_desacopladoInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_desacoplado(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_desacoplado
    ((SFc2_desacopladoInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_desacoplado();/* state var info */
...
extern void sf_internal_set_sim_state_c2_desacoplado(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_desacoplado((SFc2_desacopladoInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_desacoplado(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_desacoplado(S);
}

static void sf_opaque_set_sim_state_c2_desacoplado(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_desacoplado(S, st);
}

static void sf_opaque_terminate_c2_desacoplado(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_desacopladoInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_desacoplado((SFc2_desacopladoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_desacoplado((SFc2_desacopladoInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_desacoplado(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_desacoplado(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"desacoplado","desacoplado",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"desacoplado","desacoplado",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"desacoplado",
      "desacoplado",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"desacoplado","desacoplado",2,5);
      sf_mark_chart_reusable_outputs(S,"desacoplado","desacoplado",2,1);
    }

    sf_set_rtw_dwork_info(S,"desacoplado","desacoplado",2);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(2524396385U));
  ssSetChecksum1(S,(2464289719U));
  ssSetChecksum2(S,(588241289U));
  ssSetChecksum3(S,(2675392870U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_desacoplado(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "desacoplado", "desacoplado",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_desacoplado(SimStruct *S)
{
  SFc2_desacopladoInstanceStruct *chartInstance;
  chartInstance = (SFc2_desacopladoInstanceStruct *)malloc(sizeof
    (SFc2_desacopladoInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_desacopladoInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_desacoplado;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_desacoplado;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_desacoplado;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_desacoplado;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_desacoplado;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_desacoplado;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_desacoplado;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_desacoplado;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_desacoplado;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_desacoplado;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_desacoplado;
...
void c2_desacoplado_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_desacoplado(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_desacoplado(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_desacoplado(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_desacoplado_method_dispatcher.\n"
