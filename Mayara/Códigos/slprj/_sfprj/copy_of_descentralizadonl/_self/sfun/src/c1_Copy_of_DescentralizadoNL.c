...
#include "Copy_of_DescentralizadoNL_sfun_debug_macros.h"
...
static void initialize_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void initialize_params_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void enable_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void disable_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void set_sim_state_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void sf_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void c1_chartstep_c1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void initSimStructsc1_Copy_of_DescentralizadoNL
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance, const mxArray *c1_dx, const char_T *c1_identifier, real_T
  c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_Copy_of_DescentralizadoNLInstanceStruct
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[8]);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[16]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[18]);
static real_T c1_sqrt(SFc1_Copy_of_DescentralizadoNLInstanceStruct
                      *chartInstance, real_T c1_x);
static void c1_eml_error(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance);
static void c1_eml_scalar_eg(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance);
...
static uint8_T c1_g_emlrt_marshallIn
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_Copy_of_DescentralizadoNL, const char_T *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance, const mxArray
   *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sqrt(SFc1_Copy_of_DescentralizadoNLInstanceStruct
                      *chartInstance, real_T *c1_x);
static void init_dsm_address_info(SFc1_Copy_of_DescentralizadoNLInstanceStruct
  *chartInstance);
  ...
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Copy_of_DescentralizadoNL = 0U;
}
  ...
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_Copy_of_DescentralizadoNL;
   ...
   *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_Copy_of_DescentralizadoNL =
    c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "is_active_c1_Copy_of_DescentralizadoNL");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Copy_of_DescentralizadoNL(chartInstance);
  ...
  (SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Copy_of_DescentralizadoNL(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_Copy_of_DescentralizadoNLMachineNumber_, chartInstance->chartNumber,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance;
  chartInstance = (SFc1_Copy_of_DescentralizadoNLInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_Copy_of_DescentralizadoNL_get_eml_resolved_functions_info
  (void)
{
   ...
   *c1_b_is_active_c1_Copy_of_DescentralizadoNL, const char_T *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Copy_of_DescentralizadoNL), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Copy_of_DescentralizadoNL);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_Copy_of_DescentralizadoNL_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Copy_of_DescentralizadoNL_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Copy_of_DescentralizadoNL(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dx\",},{M[8],M[0],T\"is_active_c1_Copy_of_DescentralizadoNL\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Copy_of_DescentralizadoNL_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_Copy_of_DescentralizadoNLMachineNumber_,
           1,
           1,
           1,
           6,
...
static void sf_opaque_initialize_c1_Copy_of_DescentralizadoNL(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Copy_of_DescentralizadoNLInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*) chartInstanceVar);
  initialize_c1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Copy_of_DescentralizadoNL(void *chartInstanceVar)
{
  enable_c1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Copy_of_DescentralizadoNL(void
  *chartInstanceVar)
{
  disable_c1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Copy_of_DescentralizadoNL(void
  *chartInstanceVar)
{
  sf_c1_Copy_of_DescentralizadoNL((SFc1_Copy_of_DescentralizadoNLInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Copy_of_DescentralizadoNL
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Copy_of_DescentralizadoNL();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Copy_of_DescentralizadoNL(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Copy_of_DescentralizadoNL
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Copy_of_DescentralizadoNL(S);
}

static void sf_opaque_set_sim_state_c1_Copy_of_DescentralizadoNL(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_Copy_of_DescentralizadoNL(S, st);
}

static void sf_opaque_terminate_c1_Copy_of_DescentralizadoNL(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_Copy_of_DescentralizadoNL
      ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Copy_of_DescentralizadoNL
    ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Copy_of_DescentralizadoNL(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_Copy_of_DescentralizadoNL
      ((SFc1_Copy_of_DescentralizadoNLInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_Copy_of_DescentralizadoNL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"Copy_of_DescentralizadoNL",
      "Copy_of_DescentralizadoNL",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"Copy_of_DescentralizadoNL",
                "Copy_of_DescentralizadoNL",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "Copy_of_DescentralizadoNL","Copy_of_DescentralizadoNL",1,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"Copy_of_DescentralizadoNL",
        "Copy_of_DescentralizadoNL",1,5);
      sf_mark_chart_reusable_outputs(S,"Copy_of_DescentralizadoNL",
        "Copy_of_DescentralizadoNL",1,1);
    }

    sf_set_rtw_dwork_info(S,"Copy_of_DescentralizadoNL",
                          "Copy_of_DescentralizadoNL",1);
...
static void mdlRTW_c1_Copy_of_DescentralizadoNL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Copy_of_DescentralizadoNL",
      "Copy_of_DescentralizadoNL",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_Copy_of_DescentralizadoNL(SimStruct *S)
{
  SFc1_Copy_of_DescentralizadoNLInstanceStruct *chartInstance;
  chartInstance = (SFc1_Copy_of_DescentralizadoNLInstanceStruct *)malloc(sizeof
    (SFc1_Copy_of_DescentralizadoNLInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Copy_of_DescentralizadoNLInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Copy_of_DescentralizadoNL;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Copy_of_DescentralizadoNL;
...
void c1_Copy_of_DescentralizadoNL_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Copy_of_DescentralizadoNL(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Copy_of_DescentralizadoNL(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Copy_of_DescentralizadoNL(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Copy_of_DescentralizadoNL_method_dispatcher.\n"
