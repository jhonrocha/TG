...
#include "ComparacaoLcomNL_sfun_debug_macros.h"
...
static void initialize_c1_ComparacaoLcomNL(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static void initialize_params_c1_ComparacaoLcomNL
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance);
static void enable_c1_ComparacaoLcomNL(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static void disable_c1_ComparacaoLcomNL(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_ComparacaoLcomNL
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_ComparacaoLcomNL
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance);
static void set_sim_state_c1_ComparacaoLcomNL
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_ComparacaoLcomNL(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static void sf_c1_ComparacaoLcomNL(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_ComparacaoLcomNL(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static void initSimStructsc1_ComparacaoLcomNL
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_dx, const char_T *c1_identifier, real_T
  c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[8]);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[16]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[18]);
static real_T c1_sqrt(SFc1_ComparacaoLcomNLInstanceStruct *chartInstance, real_T
                      c1_x);
static void c1_eml_error(SFc1_ComparacaoLcomNLInstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_ComparacaoLcomNLInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_ctes_bus_io(void *chartInstanceVoid, void *c1_pData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_ComparacaoLcomNL, const
  char_T *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sqrt(SFc1_ComparacaoLcomNLInstanceStruct *chartInstance, real_T
                      *c1_x);
static void init_dsm_address_info(SFc1_ComparacaoLcomNLInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ComparacaoLcomNL = 0U;
}
  ...
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_ComparacaoLcomNL;
  ...
  (SFc1_ComparacaoLcomNLInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_ComparacaoLcomNL = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_ComparacaoLcomNL");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ComparacaoLcomNL(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_ComparacaoLcomNL(chartInstance);
  sf_debug_check_for_state_inconsistency(_ComparacaoLcomNLMachineNumber_,
  ...
  *chartInstance)
{
  ...
  for (c1_i9 = 0; c1_i9 < 2; c1_i9++) {
    c1_ctes.v0[c1_i9] = ((real_T *)((char_T *)c1_b_ctes + 176))[c1_i9];
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_ComparacaoLcomNLInstanceStruct *chartInstance;
  chartInstance = (SFc1_ComparacaoLcomNLInstanceStruct *)chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  for (c1_i27 = 0; c1_i27 < 4; c1_i27++) {
    c1_n_u[c1_i27] = c1_u.hlin[c1_i27];
  }
  ...
  for (c1_i29 = 0; c1_i29 < 2; c1_i29++) {
    c1_p_u[c1_i29] = c1_u.vlin[c1_i29];
  }
  ...
  for (c1_i30 = 0; c1_i30 < 2; c1_i30++) {
    c1_q_u[c1_i30] = c1_u.v0[c1_i30];
  }

  c1_q_y = NULL;
  sf_mex_assign(&c1_q_y, sf_mex_create("y", c1_q_u, 0, 0U, 1U, 0U, 2, 2, 1));
  sf_mex_addfield(c1_y, c1_q_y, "v0", "v0", 0);
  sf_mex_assign(&c1_mxArrayOutData, c1_y);
  return c1_mxArrayOutData;
}
...
const mxArray *sf_c1_ComparacaoLcomNL_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c1_ctes_bus_io(void *chartInstanceVoid, void *c1_pData)
{
  ...
  for (c1_i56 = 0; c1_i56 < 4; c1_i56++) {
    c1_tmp.hlin[c1_i56] = ((real_T *)((char_T *)c1_pData + 96))[c1_i56];
  }

  for (c1_i57 = 0; c1_i57 < 4; c1_i57++) {
    c1_tmp.h0[c1_i57] = ((real_T *)((char_T *)c1_pData + 128))[c1_i57];
  }

  for (c1_i58 = 0; c1_i58 < 2; c1_i58++) {
    c1_tmp.vlin[c1_i58] = ((real_T *)((char_T *)c1_pData + 160))[c1_i58];
  }

  for (c1_i59 = 0; c1_i59 < 2; c1_i59++) {
    c1_tmp.v0[c1_i59] = ((real_T *)((char_T *)c1_pData + 176))[c1_i59];
  }
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ComparacaoLcomNL), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ComparacaoLcomNL);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_ComparacaoLcomNL_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2550688959U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3854253619U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3299978074U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1777449604U);
}

mxArray *sf_c1_ComparacaoLcomNL_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_ComparacaoLcomNL(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dx\",},{M[8],M[0],T\"is_active_c1_ComparacaoLcomNL\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ComparacaoLcomNL_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_ComparacaoLcomNLInstanceStruct *chartInstance;
    chartInstance = (SFc1_ComparacaoLcomNLInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_ComparacaoLcomNLMachineNumber_,
           1,
           1,
           1,
           6,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_ComparacaoLcomNLMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_ComparacaoLcomNLMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_ComparacaoLcomNLMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_ComparacaoLcomNLMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_ComparacaoLcomNL(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInstanceVar);
  initialize_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_ComparacaoLcomNL(void *chartInstanceVar)
{
  enable_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_ComparacaoLcomNL(void *chartInstanceVar)
{
  disable_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_ComparacaoLcomNL(void *chartInstanceVar)
{
  sf_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ComparacaoLcomNL(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ComparacaoLcomNL
    ((SFc1_ComparacaoLcomNLInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ComparacaoLcomNL();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ComparacaoLcomNL(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ComparacaoLcomNL(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ComparacaoLcomNL(S);
}

static void sf_opaque_set_sim_state_c1_ComparacaoLcomNL(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_ComparacaoLcomNL(S, st);
}

static void sf_opaque_terminate_c1_ComparacaoLcomNL(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ComparacaoLcomNLInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_ComparacaoLcomNL((SFc1_ComparacaoLcomNLInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ComparacaoLcomNL(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_ComparacaoLcomNL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ComparacaoLcomNL","ComparacaoLcomNL",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ComparacaoLcomNL","ComparacaoLcomNL",1,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ComparacaoLcomNL",
      "ComparacaoLcomNL",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"ComparacaoLcomNL",
        "ComparacaoLcomNL",1,5);
      sf_mark_chart_reusable_outputs(S,"ComparacaoLcomNL","ComparacaoLcomNL",1,1);
    }

    sf_set_rtw_dwork_info(S,"ComparacaoLcomNL","ComparacaoLcomNL",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(1225632857U));
  ssSetChecksum1(S,(3354660394U));
  ssSetChecksum2(S,(1982829777U));
  ssSetChecksum3(S,(1469140167U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_ComparacaoLcomNL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ComparacaoLcomNL", "ComparacaoLcomNL",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_ComparacaoLcomNL(SimStruct *S)
{
  SFc1_ComparacaoLcomNLInstanceStruct *chartInstance;
  chartInstance = (SFc1_ComparacaoLcomNLInstanceStruct *)malloc(sizeof
    (SFc1_ComparacaoLcomNLInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ComparacaoLcomNLInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ComparacaoLcomNL;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_ComparacaoLcomNL;
...
void c1_ComparacaoLcomNL_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ComparacaoLcomNL(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ComparacaoLcomNL(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ComparacaoLcomNL(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ComparacaoLcomNL_method_dispatcher.\n"
