...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2830774447U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1338098921U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3082762381U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2059388665U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3512866675U);
    pr[1] = (double)(3804588793U);
    pr[2] = (double)(553352300U);
    pr[3] = (double)(322986806U);
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dh\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"untitled","untitled",2,5);
  ...
  ssSetChecksum0(S,(1661194692U));
  ssSetChecksum1(S,(3779772385U));
  ssSetChecksum2(S,(3569980214U));
  ssSetChecksum3(S,(2430436314U));
