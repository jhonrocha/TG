...
#include "ComparacaoLeNL_sfun.h"
#include "c1_ComparacaoLeNL.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "ComparacaoLeNL_sfun_debug_macros.h"
...
static void initialize_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void initialize_params_c1_ComparacaoLeNL
  (SFc1_ComparacaoLeNLInstanceStruct *chartInstance);
static void enable_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void disable_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_ComparacaoLeNL
  (SFc1_ComparacaoLeNLInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_ComparacaoLeNL
  (SFc1_ComparacaoLeNLInstanceStruct *chartInstance);
static void set_sim_state_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void sf_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void initSimStructsc1_ComparacaoLeNL(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct *chartInstance,
  const mxArray *c1_dx, const char_T *c1_identifier, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[8]);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[16]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[18]);
static real_T c1_sqrt(SFc1_ComparacaoLeNLInstanceStruct *chartInstance, real_T
                      c1_x);
static void c1_eml_error(SFc1_ComparacaoLeNLInstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_ComparacaoLeNLInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_ComparacaoLeNLInstanceStruct *chartInstance);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_ctes_bus_io(void *chartInstanceVoid, void *c1_pData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_ComparacaoLeNL, const char_T *
  c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sqrt(SFc1_ComparacaoLeNLInstanceStruct *chartInstance, real_T
                      *c1_x);
static void init_dsm_address_info(SFc1_ComparacaoLeNLInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ComparacaoLeNL = 0U;
}
  ...
  (SFc1_ComparacaoLeNLInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_ComparacaoLeNL;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_ComparacaoLeNL = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_ComparacaoLeNL");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ComparacaoLeNL(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_ComparacaoLeNL(chartInstance);
  sf_debug_check_for_state_inconsistency(_ComparacaoLeNLMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_ComparacaoLeNLInstanceStruct *chartInstance;
  chartInstance = (SFc1_ComparacaoLeNLInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_ComparacaoLeNL_get_eml_resolved_functions_info(void)
{
  ...
  c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ComparacaoLeNL), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ComparacaoLeNL);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_ComparacaoLeNL_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_ComparacaoLeNL_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_ComparacaoLeNL(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dx\",},{M[8],M[0],T\"is_active_c1_ComparacaoLeNL\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ComparacaoLeNL_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_ComparacaoLeNLInstanceStruct *chartInstance;
    chartInstance = (SFc1_ComparacaoLeNLInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_ComparacaoLeNLMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_ComparacaoLeNLMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_ComparacaoLeNLMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_ComparacaoLeNLMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_ComparacaoLeNL(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ComparacaoLeNLInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*)
    chartInstanceVar);
  initialize_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_ComparacaoLeNL(void *chartInstanceVar)
{
  enable_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_ComparacaoLeNL(void *chartInstanceVar)
{
  disable_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_ComparacaoLeNL(void *chartInstanceVar)
{
  sf_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ComparacaoLeNL(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ComparacaoLeNL
    ((SFc1_ComparacaoLeNLInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ComparacaoLeNL();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ComparacaoLeNL(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ComparacaoLeNL(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ComparacaoLeNL(S);
}

static void sf_opaque_set_sim_state_c1_ComparacaoLeNL(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_ComparacaoLeNL(S, st);
}

static void sf_opaque_terminate_c1_ComparacaoLeNL(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ComparacaoLeNLInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_ComparacaoLeNL((SFc1_ComparacaoLeNLInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ComparacaoLeNL(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_ComparacaoLeNL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ComparacaoLeNL","ComparacaoLeNL",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ComparacaoLeNL","ComparacaoLeNL",1,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ComparacaoLeNL",
      "ComparacaoLeNL",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"ComparacaoLeNL","ComparacaoLeNL",1,
        5);
      sf_mark_chart_reusable_outputs(S,"ComparacaoLeNL","ComparacaoLeNL",1,1);
    }

    sf_set_rtw_dwork_info(S,"ComparacaoLeNL","ComparacaoLeNL",1);
...
static void mdlRTW_c1_ComparacaoLeNL(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ComparacaoLeNL", "ComparacaoLeNL",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_ComparacaoLeNL(SimStruct *S)
{
  SFc1_ComparacaoLeNLInstanceStruct *chartInstance;
  chartInstance = (SFc1_ComparacaoLeNLInstanceStruct *)malloc(sizeof
    (SFc1_ComparacaoLeNLInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ComparacaoLeNLInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_ComparacaoLeNL;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_ComparacaoLeNL;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_ComparacaoLeNL;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ComparacaoLeNL;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ComparacaoLeNL;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_ComparacaoLeNL;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_ComparacaoLeNL;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_ComparacaoLeNL;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ComparacaoLeNL;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ComparacaoLeNL;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_ComparacaoLeNL;
...
void c1_ComparacaoLeNL_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ComparacaoLeNL(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ComparacaoLeNL(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ComparacaoLeNL(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ComparacaoLeNL_method_dispatcher.\n"
