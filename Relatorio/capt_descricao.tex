...
\begin{table}[H]
	...
	\scalebox{1}{
		\begin{tabular}{|c|c|c|c|c|c|}
			\hline
			Módulo & Descrição & Canal & Range & \jhmrow{Sinal Analógico\\Variável Física} & \jhmrow{Sinal Analógico\\Variável Física} \\
			\hline
			1756-IF8/A & Tanque 1 & xxx & 0-5 V & \jhmrow{1.49 V \\ 0 cm} & \jhmrow{2.44 V \\ 10 cm} \\
			\hline
			1756-IF8/A & Tanque 2 & xxx & 0-5 V & \jhmrow{1.41 V \\ 0 cm} & \jhmrow{2.38 V \\ 10 cm} \\
			\hline
			1756-IF8/A & Tanque 3 & xxx & 0-5 V & \jhmrow{1.41 V \\ 0 cm} & \jhmrow{2.35 V \\ 10 cm} \\
			\hline
			1756-IF8/A & Tanque 4 & xxx & 0-5 V & \jhmrow{1.53 V \\ 0 cm} & \jhmrow{2.47 V \\ 10 cm} \\
			\hline
		\end{tabular}
	}
\end{table}
...
\begin{table}[H]
	...
	\scalebox{1}{
		\begin{tabular}{|c|c|c|c|c|c|}
			\hline
			Módulo & Descrição & Canal & Range  \\
			1756-IF8/A & Bomba 1 & xxx & 0-24 V \\
			\hline
			1756-IF8/A & Bomba 2 & xxx & 0-24 V \\
			\hline
		\end{tabular}
	}
\end{table}
