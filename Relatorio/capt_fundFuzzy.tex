...
\begin{table}[!ht]
	...
	\scalebox{1}{
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			Temperatura ($ºC$) & Muito Frio & Frio & Quente & Muito Quente \\
			\hline
			0 & 1 & 0 & 0 & 0 \\
			\hline
			5 & 1 & 0 & 0 & 0 \\
...
\begin{align} \label{eqRegraIGeral}
	...
	\begin{cases}
		...
		&\textbf{ENTÃO}:
		\begin{cases}
			\dot{\Delta x}(t) = A_i \Delta x(t) + B_i \Delta u(t),\\
			y(t) = C_ix(t)
		\end{cases}
	\end{cases}
\end{align}
...
\begin{align} \label{eqModTakSug}
	\begin{cases}
		\dot{\Delta x}(t) = \frac{\sum_{i=1}^{4}  w_i(c(t))(A_i \Delta x(t) +  B_i \Delta u(t))}{\sum_{i=1}^{4} w_i(c(t))} \vspace{0.5cm}\\
